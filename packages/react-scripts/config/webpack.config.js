...
const ForkTsCheckerWebpackPlugin = require('@ehrocks/react-dev-utils/ForkTsCheckerWebpackPlugin');
const typescriptFormatter = require('@ehrocks/react-dev-utils/typescriptFormatter');
// @remove-on-eject-begin
